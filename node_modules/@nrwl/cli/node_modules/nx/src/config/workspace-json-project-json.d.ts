 ...
 */
export declare type WorkspaceJsonConfiguration = ProjectsConfigurations;
/**
...
export interface RawProjectsConfigurations extends Omit<ProjectsConfigurations, 'projects'> {
    projects: {
